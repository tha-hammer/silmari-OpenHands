...
class BamlSyncClient:
    ...
    def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="CompleteLLMRequest", args={
                "request": request,
            })
...
class BamlStreamClient:
    ...
    def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.LLMCompletionResponse, types.LLMCompletionResponse]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="CompleteLLMRequest", args={
            "request": request,
        })
        return baml_py.BamlSyncStream[stream_types.LLMCompletionResponse, types.LLMCompletionResponse](
          result,
...
class BamlHttpRequestClient:
    ...
    def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="CompleteLLMRequest", args={
            "request": request,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
