...
class BamlAsyncClient:
    ...
    async def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        baml_options: BamlCallOptions = {},
    ) -> types.LLMCompletionResponse:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.CompleteLLMRequest(request=request,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="CompleteLLMRequest", args={
                "request": request,
            })
            return typing.cast(types.LLMCompletionResponse, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.LLMCompletionResponse, types.LLMCompletionResponse]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CompleteLLMRequest", args={
            "request": request,
        })
        return baml_py.BamlStream[stream_types.LLMCompletionResponse, types.LLMCompletionResponse](
          result,
          lambda x: typing.cast(stream_types.LLMCompletionResponse, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.LLMCompletionResponse, x.cast_to(types, types, stream_types, False, __runtime__)),
          ctx,
        )
...
class BamlHttpRequestClient:
    ...
    async def CompleteLLMRequest(self, request: types.FormattedLLMRequest,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="CompleteLLMRequest", args={
            "request": request,
        }, mode="request")
        return result
    async def ExtractResume(self, resume: str,
